...
public class logsMetodo {
    ...
    String formatarData() {
        ...
        String dataHoraFormatada = agora.format(formatar);

        return dataHoraFormatada;
    }

    String cadastroUsuario(String nome, Integer id ) {
    ...
    String cadastroAluno(Integer id, String nomeAluno ,Integer idAluno ) {
        String data = formatarData();
    ...
    String cadastroCurso(Integer id, String nomeCurso, Integer idCurso) {
        String data = formatarData();
